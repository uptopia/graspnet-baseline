CUDA_VISIBLE_DEVICES=0 python3 test.py --dump_dir logs/dump_rs --checkpoint_path logs/log_rs/checkpoint-rs.tar --camera realsense --dataset_root /home/iclab/work/graspnet-baseline/data/Benchmark/graspnet
